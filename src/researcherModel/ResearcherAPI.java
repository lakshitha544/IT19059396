...
public class ResearcherAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = robj.addProjects(request.getParameter("name"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = robj.updateProject(paras.get("hidItemIDSave").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Map paras = getParasMap(request); 
		String output = robj.deleteProject(paras.get("researcherID").toString()); 
		response.getWriter().write(output); 
	}
